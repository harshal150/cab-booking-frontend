...
try {
    ...
    console.log("Decrypted Query:", decryptedQuery);  // ✅ PRINT DECRYPTED QUERY

    const queryParams = new URLSearchParams(decryptedQuery);
    console.log("Query Params Object:", queryParams); // ✅ PRINT URLSearchParams OBJECT

    // Log each parameter separately
    for (let param of queryParams.entries()) {
        console.log(`Key: ${param[0]}, Value: ${param[1]}`); // ✅ PRINT EACH PARAMETER
    }
} catch (error) {
