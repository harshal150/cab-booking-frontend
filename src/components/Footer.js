...
const Footer = () => {
  ...
  <div className="mx-auto w-full max-w-[1166px] px-1 xl:px-0">
    <div className="flex flex-col justify-between sm:px-[18px] md:flex-row md:px-0">
      <div className="md:w-[316px]">
        ...
        Book your cab now and let us handle the rest. Sit back, relax, and experience the smoothest journey to your destination.
        </p>
        <div className="mt-[18px] flex gap-4">
          ...
          >
           <Icon icon="skill-icons:linkedin" width="16" height="16" />
          </a>
        </div>
      </div>
      <div className="md:w-[316px]">
        ...
        <div className="mt-[23px] flex">
          ...
          <div className="ml-[18px]">
            ...
            >
            Banaras UP Agartala India maharastra Kolkata 344509
            </a>
            {/* <p className="font-Inter text-[12px] font-medium text-white">
              Address
            </p> */}
    ...
    <div className="flex items-center justify-center pb-8 pt-[9px] md:py-8">
      <p className="text-[10px] font-normal text-white md:text-[12px]">
        © Copyright
        {/* */}2024
        {/* */}, All Rights Reserved by Jhansi smart city
      </p>
    </div>
  </div>
</div>
